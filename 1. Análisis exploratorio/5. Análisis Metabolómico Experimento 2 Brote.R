...
data=read.csv("shoots_formato.csv")
...
barplot(total, las=2, col="skyblue", cex.axis=0.9, cex.names=1, cex.lab=1.4,
        font.lab=2, ylab="Cuantificación total", ylim=c(0, 250))
...
legend("bottomleft", legend=levels(group), pch=pch, 
...
group2=factor(c(rep("WT22", 6), rep("WT28", 6), rep("KO22", 6),
                rep("KO28", 6), rep("Ox22", 6), rep("Ox28", 5),
                rep("Psuc22", 6), rep("Psuc28", 6)))